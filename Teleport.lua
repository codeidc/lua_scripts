    ...
    player:GossipMenuAddItem(9, "|TInterface\\ICONS\\Achievement_BG_winWSG.blp:30|t |cFFFF0000古拉巴什竞技场", 0,  13)
    ...
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_Zone_Outland_01.blp:30|t 燃烧远征", 0,  5)
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_boss_murmur.blp:30|t 燃烧远征副本", 0,  6)
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_Zone_IsleOfQuelDanas.blp:30|t 燃烧远征团队副本", 0,  7)
    ...
    player:GossipMenuAddItem(9, "|TInterface\\ICONS\\INV_Misc_Rune_01:30|t 返回设定的旅馆", 0,  1000)
    ...
    --Go Home 
		...
		player:SendBroadcastMessage("恭喜你，|c00FF0000"..player:GetName().."|r。你即将安全地被传送回旅馆。")
        --end
    ...
    if (intid == 1) then -- Alliance Cities
            if (plyr == 1) or (plyr == 3) or (plyr == 4) or (plyr == 7) or (plyr == 11) then
                    player:GossipMenuAddItem(2, "|cFF0000CC|TInterface\\ICONS\\Achievement_Leader_King_Magni_Bronzebeard.blp:30|t [联盟]铁炉堡（主城）", 0,  20)
		    ...
		    player:GossipMenuAddItem(2, "|cFF990066|TInterface\\ICONS\\Achievement_Zone_GrizzlyHills_01.blp:30|t [中立]达拉然", 0,  203)
            ...
            if (plyr == 2) or (plyr == 5) or (plyr == 6) or (plyr == 8) or (plyr == 10) then
                    player:GossipMenuAddItem(2, "|cFF000000|TInterface\\ICONS\\Achievement_Leader_ Thrall.blp:30|t [部落]奥格瑞玛（主城）", 0,  23)
    ...
    if (intid == 20) then -- Ironforge
            player:Teleport(0, -4923.17, -956.568, 501.513, 0)
            player:GossipComplete()
    end
    ...
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_Boss_PrinceKeleseth.blp:30|t 艾泽拉斯副本", 0,  3)
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_Zone_Blackrock_01.blp:30|t 艾泽拉斯团队副本", 0,  4)
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_Zone_Outland_01.blp:30|t 燃烧的远征", 0,  5)
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_boss_murmur.blp:30|t 燃烧远征副本", 0,  6)
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_Zone_IsleOfQuelDanas.blp:30|t 燃烧远征团队副本", 0,  7)
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_Zone_Northrend_01.blp:30|t 诺森德", 0,  8)
    player:GossipMenuAddItem(2, "|TInterface\\LFGFrame\\LFGIcon-TheForgeofSouls.blp:30|t 诺森德副本", 0,  9)
    player:GossipMenuAddItem(2, "|TInterface\\ICONS\\Achievement_Zone_IceCrown_01.blp:30|t 诺森德团队副本", 0,  10)
    player:GossipMenuAddItem(9, "|TInterface\\ICONS\\INV_Misc_Rune_01:30|t 返回设定的旅店", 0,  1000)
    player:GossipSendMenu(1, item)
    end
    end
     
    RegisterItemGossipEvent(34835, 1, Tele_Book)
    RegisterItemGossipEvent(34835, 2, Tele_Select)